...
function setupComponent(player, component, config) {
    ...
    if (config.spriteAssetId != null) {
        var sprite = player.getOuterAsset(config.spriteAssetId);
        if (sprite == null)
            return;
        if (!config.overrideOpacity)
        ...
        if (config.animationId != null) {
            ...
            sprite.__inner.animations.every(function (animation) {
...
},{"./SpriteRenderer":3,"./sprite":5}],5:[function(require,module,exports){
"use strict";
